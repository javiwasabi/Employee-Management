          ...
          <table className="w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="border p-2">Solicitud</th>
              ...
              {permissions.flatMap((permiso, index) =>
                permiso.permisos.map((permisoItem: any, subIndex: any) => (
                  <tr key={`${index}-${subIndex}`} className="border">
                    <td className="border p-2">{permisoItem.tipoPermiso}</td>
                    <td className="border p-2">{permisoItem.estado}</td>
                    <td className="border p-2">{formatDate(permisoItem.fechaSolicitud)}</td>
                    <td className="border p-2">{formatDate(permisoItem.fechaInicio)}</td>
                    <td className="border p-2">{permisoItem.fechaTermino ? formatDate(permisoItem.fechaTermino) : "No especificada"}</td>
                    <td className="border p-2">{permisoItem.nDias}</td>
                  </tr>
                ))
              )}
            </tbody>
            ...
            <tbody>
              {training.map((capacitacion, index) => (
                <tr key={index} className="border">
                  <td className="border p-2">{capacitacion.nombreCapacitacion}</td>
                  <td className="border p-2">{capacitacion.horasRealizadas}</td>
                  <td className="border p-2">{capacitacion.nota}</td>
                  <td className="border p-2">{capacitacion.PesoRelativo}</td>
                </tr>
              ))}
            </tbody>
          </table>
